...
export default function CaseStudy() {
    return (
        <section className="mx-auto max-w-screen-xl py-10 flex flex-col gap-5 px-4 sm:px-6 lg:px-8">
            {/* Header Section */}
